# -*- coding: utf-8 -*-
"""
Created on Mon May 22 15:27:49 2023
...
def simulate_pendulum_kutta2(p):
    ...
    while t[i] <= t_e:
        ...
        theta_dot += k2_theta_ddot
        theta.append(theta[i] + k2_theta_dot)
        t.append(t[i] + h)
        i += 1
...
if __name__=='__main__':
    ...
    sim_pendulum_plot(parameters, 'h' , 'ex1-3-2out.png')